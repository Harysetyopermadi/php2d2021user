...
public class Nutrisi extends AppCompatActivity {
    ...
    ImageView back;
    private static final String URL_BACANUTRISI = "https://php2d.himauntika.com/app/bacanutrisi.php";
    private static final String URL_KONTROL = "https://php2d.himauntika.com/app/kontrol.php";
    private static final String URL_BACAMESIN = "https://php2d.himauntika.com/app/mesinnutrisi.php";
