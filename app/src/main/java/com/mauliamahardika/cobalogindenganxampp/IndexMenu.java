...
public class IndexMenu extends AppCompatActivity {
    ...
    private static String URL_READ = "https://php2d.himauntika.com/app/read_detail.php";
    ...
    private void setupSlider() {
        ...
        //link image
        fragments.add(FragmentSlider.newInstance("https://php2d.himauntika.com/app/gambarslide/satu.jpeg"));
        fragments.add(FragmentSlider.newInstance("https://php2d.himauntika.com/app/gambarslide/dua.jpeg"));
        fragments.add(FragmentSlider.newInstance("https://php2d.himauntika.com/app/gambarslide/tiga.jpeg"));
        fragments.add(FragmentSlider.newInstance("https://php2d.himauntika.com/app/gambarslide/empat.jpeg"));
        fragments.add(FragmentSlider.newInstance("https://php2d.himauntika.com/app/gambarslide/lima.jpeg"));
        fragments.add(FragmentSlider.newInstance("https://php2d.himauntika.com/app/gambarslide/enam.jpeg"));
